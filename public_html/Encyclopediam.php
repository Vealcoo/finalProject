                ...
                <div class="header">
                  <div id="mobile">
                      ...
                      <li><?php session_start();
                          ...
                          <li><a href="Encyclopediam.php"><font face="Noto Sans TC">小百科</font></a></li>
                          <li id="intro"><a href="#"><font face="Noto Sans TC">關於我們</font></a></li>
                      </ul>
          <script>
            if ($(window).width() <= 798){
          $(function(){
              ...
              $toggle.click(function(e) {
                  $menu.slideToggle()
                      ...
                      <li><?php session_start();
                        ...
                        <li ><a href="logout.php"><font face="Noto Sans TC">登出</font></a></li>                          <li id="contact"><a href="#"><font face="Noto Sans TC">聯絡我們</font></a></li>
                      </ul>
                      <script>    
