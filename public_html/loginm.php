                      ...
                      <ul class="menu">
                          ...
                          <li><?php session_start();
                              if(isset($_SESSION["login_session"])){
                                echo "<font face='Noto Sans TC'><a href='loginm.php'>首頁</a></font>";
                          ...
                          <li><a href="memberadminDone.php"><font face="Noto Sans TC">管理會員資料</font></a></li>
                          <li><a href="historyadminDone.php"><font face="Noto Sans TC">管理歷史結果</font></a></li>
                      </ul>
<script>
  if ($(window).width() <= 798){
$(function(){
   var  $mobile = $('#mobile') ,
    ...
    $toggle.click(function(e) {
        $menu.slideToggle()
                      ...
                      <ul class="login">
                      <li><?php session_start();
                            echo 	"<font face='Noto Sans TC'>".$_SESSION["username"]. " 管理員您好". "</font>";
                          ?>
                          </li>
